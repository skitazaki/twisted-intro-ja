...
..
    ...
    <PRE>def get_poetry(host, post):
        """Return the text of a poem from the poetry server at the given host and port."""</PRE>
    ...
    <PRE>def get_poetry(host, port, callback):
        """
        Download a poem from the given host and port and invoke
    ...
    <PRE>class PoetryProtocol(Protocol):
        ...
        def poemReceived(self, poem):
            self.factory.poem_finished(poem)</PRE>
    ...
    <PRE>try:
        ...
        # the code path when things go so, so right baby</PRE>
    ...
    <PRE>def get_poetry(host, port, callback, errback):
        """
        Download a poem from the given host and port and invoke
